...
var Rg=[K.C,K.I],Sg=function(a){var b=a[K.dd];b&&Ef(40);var c=a[K.ve];c&&Ef(41);for(var d=Ra(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==K.dd&&f!==K.ve)if(-1<Sa(Rg,f)){var g=f,h=a[f],l=d[e];xg().set(g,h,l,"US","US-CA",c)}else{}},Tg=function(a,
...
Z.h.sdl=["google"],function(){function a(){return!!(Object.keys(l("horiz.pix")).length||Object.keys(l("horiz.pct")).length||Object.keys(l("vert.pix")).length||Object.keys(l("vert.pct")).length)}function b(x){for(var y=[],B=x.split(","),C=0;C<B.length;C++){var E=Number(B[C]);if(isNaN(E))return[];p.test(B[C])||y.push(E)}return y}function c(){var x=0,y=0;return function(){var B=dh(),C=B.height;x=Math.max(v.scrollLeft+B.width,x);y=Math.max(v.scrollTop+C,y);return{Md:x,Nd:y}}}function d(){u=U("self");
t=u.document;v=t.scrollingElement||t.body&&t.body.parentNode;z=c()}function e(x,y,B,C){var E=l(y),D={},I;for(I in E){D.$a=I;if(E.hasOwnProperty(D.$a)){var P=Number(D.$a);x<P||(os({event:"gtm.scrollDepth","gtm.scrollThreshold":P,"gtm.scrollUnits":B.toLowerCase(),"gtm.scrollDirection":C,"gtm.triggers":E[D.$a].join(",")}),bp("sdl",y,function(Q){return function(V){delete V[Q.$a];return V}}(D),{}))}D={$a:D.$a}}}function f(){var x=z(),y=x.Md,B=x.Nd,C=y/v.scrollWidth*100,E=B/v.scrollHeight*100;e(y,"horiz.pix",
q.Cc,r.ff);e(C,"horiz.pct",q.Bc,r.ff);e(B,"vert.pix",q.Cc,r.wf);e(E,"vert.pct",q.Bc,r.wf);ap("sdl","pending",!1)}function g(){var x=250,y=!1;t.scrollingElement&&t.documentElement&&u.addEventListener&&(x=50,y=!0);var B=0,C=!1,E=function(){C?B=is(E,x):(B=0,f(),ts("sdl")&&!a()&&(jg(u,"scroll",D),jg(u,"resize",D),ap("sdl","init",!1)));C=!1},D=function(){y&&z();B?C=!0:(B=is(E,x),ap("sdl","pending",!0))};return D}function h(x,y,B){if(y){var C=b(String(x));bp("sdl",B,function(E){for(var D=0;D<C.length;D++){var I=
String(C[D]);E.hasOwnProperty(I)||(E[I]=[]);E[I].push(y)}return E},{})}}function l(x){return cp("sdl",x,{})}function m(x){N(x.vtp_gtmOnSuccess);var y=x.vtp_uniqueTriggerId,B=x.vtp_horizontalThresholdsPixels,C=x.vtp_horizontalThresholdsPercent,E=x.vtp_verticalThresholdUnits,D=x.vtp_verticalThresholdsPixels,I=x.vtp_verticalThresholdsPercent;switch(x.vtp_horizontalThresholdUnits){case q.Cc:h(B,y,"horiz.pix");break;case q.Bc:h(C,y,"horiz.pct")}switch(E){case q.Cc:h(D,y,"vert.pix");break;case q.Bc:h(I,
y,"vert.pct")}ts("sdl")?cp("sdl","pending")||(w||(d(),w=!0),N(function(){return f()})):(d(),w=!0,v&&(us("sdl"),ap("sdl","pending",!0),N(function(){f();if(a()){var P=g();ig(u,"scroll",P);ig(u,"resize",P)}else ap("sdl","init",!1)})))}var p=/^\s*$/,q={Bc:"PERCENT",Cc:"PIXELS"},r={wf:"vertical",ff:"horizontal"},u,t,v,w=!1,z;(function(x){Z.__sdl=x;Z.__sdl.i="sdl";Z.__sdl.m=!0;Z.__sdl.priorityOverride=0})(function(x){x.vtp_triggerStartOption?m(x):dq(function(){m(x)})})}();
...
Z.h.d=["google"],function(){(function(a){Z.__d=a;Z.__d.i="d";Z.__d.m=!0;Z.__d.priorityOverride=0})(function(a){var b=null,c=null,d=a.vtp_attributeName;if("CSS"==a.vtp_selectorType)try{var e=Zg(a.vtp_elementSelector);e&&0<e.length&&(b=e[0])}catch(f){b=null}else b=L.getElementById(a.vtp_elementId);b&&(d?c=kg(b,d):c=lg(b));return hb(String(b&&c))})}();
...
"string"==typeof q.vtp_trackerName?""!==q.vtp_trackerName&&(E=q.vtp_trackerName,C=E+"."):(E="gtm"+$h(),C=E+".");var D=function(pa){var ca=[].slice.call(arguments,0);ca[0]=C+ca[0];B.apply(window,ca)},I=function(pa,ca){return void 0===ca?ca:pa(ca)},P=function(pa,ca){if(ca)for(var Db in ca)ca.hasOwnProperty(Db)&&D("set",pa+Db,ca[Db])},Q=function(){},V={name:E};l(y,V,!0);var qa=q.vtp_trackingId||u.trackingId;B("create",qa,V);D("set","&gtm",Qm(!0));var W=!1;
...
Z.h.ytl=["google"],function(){function a(){var t=Math.round(1E9*Math.random())+"";return L.getElementById(t)?a():t}function b(t,v){if(!t)return!1;for(var w=0;w<p.length;w++)if(0<=t.indexOf("//"+p[w]+"/"+v))return!0;return!1}function c(t,v){var w=t.getAttribute("src");if(b(w,"embed/")){if(0<w.indexOf("enablejsapi=1"))return!0;if(v){var z=t.setAttribute,x;var y=-1!==w.indexOf("?")?"&":"?";if(-1<w.indexOf("origin="))x=w+y+"enablejsapi=1";else{if(!r){var B=U("document");r=B.location.protocol+"//"+B.location.hostname;
...
w.getElementsByTagName("iframe"),x=z.length,y=0;y<x;y++)d(z[y],t)}var w=U("document");v();Gp(v)})}function f(t,v){var w,z;function x(){V=Hp(function(){return{url:M,title:Y,Od:W,Ef:t.getCurrentTime(),playbackRate:aa}},v.se,t.getIframe());W=0;Y=M="";aa=1;return y}function y(za){switch(za){case q.PLAYING:W=Math.round(t.getDuration());M=t.getVideoUrl();if(t.getVideoData){var ka=t.getVideoData();Y=ka?ka.title:""}aa=t.getPlaybackRate();v.Jd?os(V.createEvent("start")):V.nb();qa=l(v.he,v.fe,t.getDuration());
return B(za);default:return y}}function B(){xa=t.getCurrentTime();S=js().getTime();V.Sf();Q();return C}function C(za){var ka;switch(za){case q.ENDED:return D(za);case q.PAUSED:ka="pause";case q.BUFFERING:var Ma=t.getCurrentTime()-xa;ka=1<Math.abs((js().getTime()-S)/1E3*aa-Ma)?"seek":ka||"buffering";t.getCurrentTime()&&(v.Id?os(V.createEvent(ka)):V.nb());P();return E;case q.UNSTARTED:return x(za);default:return C}}function E(za){switch(za){case q.ENDED:return D(za);case q.PLAYING:return B(za);case q.UNSTARTED:return x(za);
default:return E}}function D(){for(;z;){var za=w;hs(z);za()}v.Hd&&os(V.createEvent("complete",1));return x(q.UNSTARTED)}function I(){}function P(){z&&(hs(z),z=0,w=I)}function Q(){if(qa.length&&0!==aa){var za=-1,ka;do{ka=qa[0];if(ka.V>t.getDuration())return;za=(ka.V-t.getCurrentTime())/aa;if(0>za&&(qa.shift(),0===qa.length))return}while(0>za);w=function(){z=0;w=I;0<qa.length&&qa[0].V===ka.V&&(qa.shift(),os(V.createEvent("progress",ka.$b,ka.bc)));Q()};z=is(w,1E3*za)}}var V,qa=[],W,M,Y,aa,xa,S,Ga=x(q.UNSTARTED);
z=0;w=I;return{onStateChange:function(za){Ga=Ga(za)},onPlaybackRateChange:function(za){xa=t.getCurrentTime();S=js().getTime();V.nb();aa=za;P();Q()}}}function g(t){for(var v=t.split(","),w=v.length,z=[],x=0;x<w;x++){var y=parseInt(v[x],10);isNaN(y)||100<y||0>y||z.push(y/100)}z.sort(function(B,C){return B-C});return z}function h(t){for(var v=t.split(","),w=v.length,z=[],x=0;x<w;x++){var y=parseInt(v[x],10);isNaN(y)||0>y||z.push(y)}z.sort(function(B,C){return B-C});return z}function l(t,v,w){var z=t.map(function(B){return{V:B,
...
E=U("YT"),D=function(){e(C)};N(t.vtp_gtmOnSuccess);if(E)E.ready&&E.ready(D);else{var I=U("onYouTubeIframeAPIReady");ps("onYouTubeIframeAPIReady",function(){I&&I();D()});N(function(){for(var P=U("document"),Q=P.getElementsByTagName("script"),V=Q.length,qa=0;qa<V;qa++){var W=Q[qa].getAttribute("src");if(b(W,"iframe_api")||b(W,"player_api"))return}for(var M=P.getElementsByTagName("iframe"),Y=M.length,aa=0;aa<Y;aa++)if(!u&&c(M[aa],C.Tb)){R("https://www.youtube.com/iframe_api");u=!0;break}})}}else N(t.vtp_gtmOnSuccess)}
var p=["www.youtube.com","www.youtube-nocookie.com"],q={UNSTARTED:-1,ENDED:0,PLAYING:1,PAUSED:2,BUFFERING:3,CUED:5},r,u=!1;(function(t){Z.__ytl=t;Z.__ytl.i="ytl";Z.__ytl.m=!0;Z.__ytl.priorityOverride=0})(function(t){t.vtp_triggerStartOption?m(t):ml(function(){m(t)})})}();
...
Z.h.img=["customPixels"],function(){(function(a){Z.__img=a;Z.__img.i="img";Z.__img.m=!0;Z.__img.priorityOverride=0})(function(a){var b=mg('<a href="'+a.vtp_url+'"></a>')[0].href,c=a.vtp_cacheBusterQueryParam;if(a.vtp_useCacheBuster){c||(c="gtmcb");var d=b.charAt(b.length-1),e=0<=b.indexOf("?")?"?"==d||"&"==d?"":"&":"?";b+=e+c+"="+a.vtp_randomNumber}at(b,a.vtp_gtmOnSuccess,a.vtp_gtmOnFailure)})}();
