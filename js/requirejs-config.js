...
var config = {
    map: {
        '*': {
            'polywood/compare': 'Polywood_Compare/js/ajax-compare'
        }
    }
};
...
var config = {
    map: {
        '*': {
            magnificPopup: 'Polywood_Rewrites/js/jquery.magnific-popup.min'
        }
    },
    shim: {
        magnificPopup: {
...
var config = {
    map: {
        '*': {
            'sectional-planner': 'Polywood_SectionalPlanner/build',
            'fabricjs'         : 'Polywood_SectionalPlanner/fabric',
        }
    }
};
require.config(config);
...
(function() {
var config = {
    deps:['corraui', 'global', 'home', 'uniformJs', 'megaMenu'],
        paths: {
        'corraui'           : 'js/corra-ui.min',
        'global'            : 'js/global.min',
        'threesixty'        : 'js/threesixty.min',
        'glide'             : 'js/glide.min',
        'uniformJs'         : 'js/jquery.uniform.min',
        'owlcarousel'       : 'js/owl.carousel.min',  
        'backToTop'         : 'js/back-to-top.min',        
        'slimscroll'        : 'js/jquery.slimscroll.min',
        'home'              : 'js/home.min',
        'plp'               : 'js/plp.min',
        'asPieProgress'     : 'js/as-pie-progress.min',
        'productFilter'     : 'js/product-filter.min',
        'cart'              : 'js/cart.min',
        'megaMenu'          : 'js/mega-menu.min'
        //'googleApi'         : 'https://maps.google.com/maps/api/js?sensor=false&v=3&libraries=geometry'
    ...
    shim: {
        ...
        'uniformJs'         : ['corraui'],
        'backToTop'         : ['corraui'],
        'asPieProgress'     : ['jquery'],
        'slimscroll'        : ['jquery'],
        'global'            : ['corraui', 'backToTop', 'uniformJs', 'accordion', 'slimscroll'],// 'googleApi',
        'owlcarousel'       : ['global'],
        'fotorama/fotorama' : ['jquery'],
        'fotorama/fotorama.min' : ['jquery'],
        'home'              : ['global', 'owlcarousel'],
        'productFilter'     : ['global'],
        'cart'              : ['global', 'owlcarousel'],
        'plp'               : ['global', 'productFilter', 'asPieProgress', 'slimscroll'],
        'megaMenu'          : [ 'jquery', 'matchMedia', 'jquery/ui','corraui']
    },
