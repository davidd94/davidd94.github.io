var _scq = _scq || [];
_scq.push(['setMerchantId', '1ED173CEFA4AC4B7']);
var _scwebpersonalization = _scwebpersonalization || {"wp_merchant_id":"10518F1C2B327082","default_config":{"customer_id":"794756183","sentry_enabled":false,"rank_based_sorting_on_ui":true,"dcache_enabled_for_all_visitors":true,"cookie_storage_disabled":true}};
...
var ScarabUtil = function() {
  ...
  var createStorageFactory = function createStorageFactory(noTopDomain, w, errorHandler) {
    ...
    var CookieStorage = function CookieStorage() {
      ...
      function get(name) {
        ...
        try {
          ...
          return ScarabUtil.JSONParser(value);
        }
      }
    ...
    return {getStorageForData:function getStorageForData(name) {
      if (w.emarsysCookieLessEnabled) {
        ...
        var nonCookieStorage = dataToStorage[name];
...
;var ScarabModule = function(win, config) {
  ...
  Transaction.prototype = {eventHandlers:{addView:function(viewedItem) {
    ...
    if (vis) {
      ...
      storage.set(STRINGS.VISITORCOOKIE, '"' + vis + '"', expiration.toUTCString());
    }
  ...
  var storageFactory = ScarabUtil.createStorageFactory(noTopDomain, w, publicInterface.errorMessage);
  var init = function() {
